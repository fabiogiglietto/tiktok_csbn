...
if (exists("accounts_table") && !is.null(accounts_table)) {
  accounts_table  # The table is already a DT::datatable object
} else {
...
if (exists("clusters_table") && !is.null(clusters_table)) {
  clusters_table  # The table is already a DT::datatable object
} else {
...
if (exists("posts_table") && !is.null(posts_table)) {
  posts_table  # The table is already a DT::datatable object
} else {
