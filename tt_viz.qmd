...
prepare_download_files <- function() {
  ...
  # Save tables as CSV - extract data from datatables
  write.csv(accounts_table$x$data, file.path(temp_dir, "coordinated_accounts.csv"), row.names = FALSE)
  write.csv(clusters_table$x$data, file.path(temp_dir, "network_clusters.csv"), row.names = FALSE)
  write.csv(posts_table$x$data, file.path(temp_dir, "coordinated_posts.csv"), row.names = FALSE)
  ...
  # Get files to zip with base names only
