  ...
  datatable(
    ...
    options = list(
      ...
      columnDefs = list(
        ...
        list(width = '300px', targets = 0),  # Adjust width of Network column
        list(targets = 9, render = JS(   # Truncate Member Accounts and show full list on hover
          "function(data, type, row, meta) {",
  ...
  datatable(
    ...
    options = list(
      ...
      columnDefs = list(
        ...
        list(width = '300px', targets = 0),  # Adjust width of Post URL column
        list(targets = 8, render = JS(   # Truncate Description and show full text on hover
          "function(data, type, row, meta) {",
          "return type === 'display' && data.length > 60 ?",
          "'<span title=\"' + data + '\">' + data.substr(0, 60) + '...</span>' : data;",
          "}"
...
# Update the main code section where tables are created:
