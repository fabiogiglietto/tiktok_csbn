...
```{r display_accounts, echo=FALSE, warning=FALSE, message=FALSE}

if (exists("accounts_table") && !is.null(accounts_table)) {
  accounts_table  # DT::datatable object
} else {
...
```{r display_clusters, echo=FALSE, warning=FALSE, message=FALSE}
...
## Coordinated Posts
```{r display_posts, echo=FALSE, warning=FALSE, message=FALSE}
