...
if (exists("coordination_results") && exists("all_videos")) {
  ...
  tryCatch({
    ...
    log_error(sprintf("Error creating tables: %s", e$message))
    print(str(coordination_results))  # Debug print of coordination results structure
  })
} else {
...
if (exists("accounts_table") && !is.null(accounts_table)) {
  ...
  if (!exists("accounts_table")) {
    cat("accounts_table variable does not exist\n")
  } else {
...
if (exists("clusters_table") && !is.null(clusters_table)) {
  ...
  if (!exists("clusters_table")) {
    cat("clusters_table variable does not exist\n")
  } else {
...
if (exists("posts_table") && !is.null(posts_table)) {
  ...
  if (!exists("posts_table")) {
    cat("posts_table variable does not exist\n")
  } else {
