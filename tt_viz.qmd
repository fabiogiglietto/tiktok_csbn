...
```{r generate_network_function, include=FALSE}
...
generate_network_visualization <- function(coordination_results, 
  ...
  custom_css <- paste0(
    "<style>",
    ".vis-network { border: 1px solid #ddd; border-radius: 4px; }",
    ".node-tooltip { padding: 10px; max-width: 300px; }",
    ".node-tooltip p { margin: 5px 0; }",
    ".vis-network-configuration { padding: 10px; background: #f8f9fa; border-radius: 4px; }",
    ".vis-network-configuration select { max-width: 100%; }",
    "</style>"
  )
