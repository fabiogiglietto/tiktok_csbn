...
generate_network_visualization <- function(coordination_results,
  ...
  tryCatch({
    ...
    data$nodes$title <- sprintf(
      "<div style='font-family: Comfortaa, sans-serif; padding: 8px; background: white; border: 1px solid %s; border-radius: 4px; color: %s;'>
       <strong>@%s</strong><br>Connections: %d</div>",
      vera_colors$green,
      vera_colors$dark,
      data$nodes$id,
      data$nodes$value
    ...
    data$edges <- data$edges %>%
      dplyr::mutate(
        ...
        color = vera_colors$dark,
        physics = TRUE
      )
    
    # Custom CSS for vera.ai branding
    custom_css <- paste0(
      "<style>
        @import url('https://fonts.googleapis.com/css2?family=Comfortaa:wght@300;700&display=swap');
        ...
        #network-viz-container .network-tooltip { 
          padding: 8px; 
          background: white; 
          border: 1px solid ", vera_colors$green, "; 
          border-radius: 4px; 
        }
        #network-viz-container select { 
          font-family: 'Comfortaa', sans-serif;
          border: 1px solid ", vera_colors$green, ";
          border-radius: 4px;
          padding: 4px 8px;
    ...
    network <- visNetwork::visNetwork(
      ...
      height = height,
      main = list(
        text = "Coordinated Account Network",
        style = paste0("font-family: 'Comfortaa', sans-serif; color: ", vera_colors$dark, "; font-size: 16px; font-weight: bold;")
      )
    ) %>%
      ...
      visNetwork::visOptions(
        ...
        selectedBy = list(
          variable = "group",
          main = "Select Network",
          style = paste0("font-family: 'Comfortaa', sans-serif; width: 200px; height: 30px; margin: 8px; border: 1px solid ", vera_colors$green, "; border-radius: 4px;")
        ),
      ...
      visNetwork::visNodes(
        color = list(
          background = vera_colors$green,
          border = vera_colors$dark,
          highlight = list(
            background = "#00b485",  # Slightly lighter green for highlight
            border = vera_colors$dark
          ),
          hover = list(
            background = "#00b485",
      ...
      visNetwork::visEdges(
        color = list(
          color = vera_colors$dark,
          highlight = vera_colors$green,
          hover = vera_colors$green
        ),
