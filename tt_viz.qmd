...
generate_network_visualization <- function(coordination_results) {
  ...
  tryCatch({
    ...
    # Create strictly isolated CSS
    isolated_css <- paste0(
      "<style>",
      ".coordination-network-viz {",
      "  position: relative;",
      "  z-index: 1;",
      "  all: initial;", # Reset all properties
      "  display: block;",
      "  contain: content;", # Contain any layout/style effects
      "}",
      ".coordination-network-viz * {",
      "  all: revert;", # Reset all inherited properties
      "}",
      ".coordination-network-viz .vis-network {",
      "  position: relative !important;",
      "  border: none !important;",
      "  box-sizing: content-box !important;",
      "}",
      ".coordination-network-viz .vis-network-configuration {",
      ...
      "  color: #333 !important;",
      "}",
      ".coordination-network-viz .vis-network-configuration select {",
      "  width: 100% !important;",
      ...
      "}",
      ".coordination-network-viz .vis-navigation {",
      "  position: absolute !important;",
      "  z-index: 100 !important;",
      "}",
      "</style>"
    ...
    container_div <- sprintf(
      '<div class="coordination-network-viz">%s</div>',
      isolated_css
    )
    ...
    network <- visNetwork(
      ...
      htmlwidgets::onRender(sprintf("
        function(el,x) {
          // Wrap the network in the container div
