...
# Identify video descriptions that appear at least twice in all_videos
descriptions_with_min_two_occurrences <- recent_videos %>%
...
# Get unique video descriptions from recent_videos that are in the above list
video_desc <- unique(recent_videos$video_description[recent_videos$video_description %in% descriptions_with_min_two_occurrences])
```
