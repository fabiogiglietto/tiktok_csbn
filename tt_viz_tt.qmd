...
```{r results_summary, include=FALSE, results='asis'}
...
```{r new-accounts-plot, include=FALSE, fig.cap="Trend of newly discovered TikTok accounts.", message=FALSE}
...
```{r interactive-plot, include=FALSE, fig.cap="Interactive visualization of coordinated account detected today. Click on a node to visit the respective TikTok account."}
